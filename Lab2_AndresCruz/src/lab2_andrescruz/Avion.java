...
public class Avion {
    ...
    public Avion(String codigo, int aniof, int anioa, int cap, double peso, double horas, int motores, String ingcarg) {//Constructor general
        this.codigo = codigo;
        this.aniof = aniof;
        this.anioa = anioa;
        this.cap = cap;
